    ...
    <div className="bg-gradient-to-r from-[#ffffff] via-[#f9f8f8] to-[#f9f6f6] w-full">
      <section className="w-full h-[50%] z-0 relative page-top-background pt-36 pb-20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center justify-center">
            <span className="gradient-text font-medium text-xl">
              Our Pricing
            </span>
            <span className="font-bold text-3xl md:text-5xl mt-6 md:text-left text-center">
              Pricing Plans That Suit You
            </span>
            <p className="text-xl mt-6 text-center text-gray-500">
              Customize your pricing plan to fit your needs perfectly.
              <br /> Find the ideal option for your need and get started
              hassle-free.
            </p>
          </div>
        </div>
      ...
      <section className="w-full z-0 relative pt-10 pb-24">
        <div className="max-w-7xl mx-auto h-full">
          ...
          <div className="overflow-x-auto px-10 md:px-0">
            <table className="min-w-full table-auto bg-white shadow-xl rounded-xl overflow-hidden ">
              ...
              <tbody>
                {data?.map((plan, index) => (
                  <tr
                    ...
                    key={index}
                  >
                    <td className="py-3 px-4 text-left text-sm md:text-base">
                      {plan.options}
                    </td>
                    <td className="py-3 px-4 text-center text-sm md:text-base">
                      {plan.subscriptions_ids.includes("1") ? "✔" : "✘"}
                    </td>
                    <td className="py-3 px-4 text-center text-sm md:text-base">
                      {plan.subscriptions_ids.includes("2") ? "✔" : "✘"}
                    </td>
                    <td className="py-3 px-4 text-center text-sm md:text-base">
                      {plan.subscriptions_ids.includes("3") ? "✔" : "✘"}
                    </td>
                  </tr>
                ))}
              </tbody>
