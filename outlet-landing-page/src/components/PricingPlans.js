            ...
            <div className="border-2 border-gray-300 hover:border-blue-500 rounded-3xl h-full w-full group transition-all duration-500 ease-in-out pb-4">
              ...
              <div className="w-full h-[80%] flex flex-col items-center">
                <div className="mt-5 flex items-center justify-center">
                  <span class="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white text-xl font-bold px-3 py-1 rounded-full shadow-lg animate-pulse hover:scale-105 transition-transform duration-300 text-center">
                    1 Month Free
                  </span>
                </div>
