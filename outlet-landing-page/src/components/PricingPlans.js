    ...
    return (
        <div className="flex flex-col justify-center w-full h-full">
            ...
            <div className="flex justify-center items-center">
                <div className="p-[2px] rounded-full" style={{ background: 'linear-gradient(90deg, #3b82f6, #14b8a6)' }}>
                    <ul className="flex p-1 rounded-full bg-white">
                        <li
                            className={`flex items-center text-center cursor-pointer py-4 px-5 text-lg rounded-full  ${selectedPlan === 'monthly' ? 'bg-gradient-to-r from-blue-500 to-teal-500 text-white' : 'text-gray-600'
                                }`}
                        ...
                        <li
                            className={`flex items-center text-center cursor-pointer py-4 px-5 text-lg rounded-full ${selectedPlan === 'annual' ? 'bg-gradient-to-r from-blue-500 to-teal-500 text-white' : 'text-gray-600'
                                }`}
                                ...
                                <li className="flex w-full items-center justify-start pl-10">
                                    <div className=" rounded-full bg-[#EBF4FE] p-2">
                                        <svg width="13" height="11" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.2596 10.677C5.25791 10.677 5.25594 10.677 5.25425 10.677C5.18438 10.6756 5.11846 10.6466 5.07112 10.5969L0.240477 5.49889C0.157647 5.41139 0.15004 5.27959 0.222446 5.18362C0.294853 5.08791 0.426705 5.0551 0.537709 5.10541L4.95899 7.11463C4.99618 7.13158 5.04013 7.12338 5.06859 7.09467L11.8128 0.253538C11.9041 0.160843 12.0534 0.150726 12.1571 0.23057C12.2607 0.310413 12.2847 0.453695 12.2123 0.561155L5.50359 10.5356C5.49401 10.5501 5.48274 10.5632 5.47034 10.5755L5.44076 10.6042C5.39258 10.6507 5.32722 10.677 5.2596 10.677Z" fill="url(#paint0_linear_676_2806)"></path>
                                            <defs>
                                                <linearGradient id="paint0_linear_676_2806" x1="0.172852" y1="5.10729" x2="12.254" y2="5.10729" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#6B70FF"></stop>
                                                    <stop offset="1" stop-color="#0BB0EE"></stop>
                                                </linearGradient>
                                            </defs>
                                        </svg>
                                    </div>
